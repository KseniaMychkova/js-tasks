// Напишите программу, которая находит полное число метров по заданному числу сантиметров. Добавьте проверку на ввод только чисел.
...
if (isNaN(sant)) {
    ...
    console.log(Math.floor(sant * 0.01));
}